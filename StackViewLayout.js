...
class StackViewLayout extends React.Component {
  ...
  _renderHeader(scene, headerMode) {
    ...
    const {BarOptions, transitionProps, ...passProps } = this.props;
  ...
  _reset(resetToIndex, duration) {
    ...
    this.props.gestureCanceledListener && this.props.gestureCanceledListener(resetToIndex, duration);
  }
  ...
  _goBack(backFromIndex, duration) {
    ...
    this.props.gestureFinishListener && this.props.gestureFinishListener(backFromIndex, duration);
  }
  ...
  _panResponder = PanResponder.create({
    ...
    onPanResponderGrant: () => {
      ...
      this.props.gestureBeginListener && this.props.gestureBeginListener();
    },
    ...
    onPanResponderMove: (event, gesture) => {
      ...
      this.props.gestureListener && this.props.gestureListener(value);
    },
  ...
  render() {
    ...
    if (headerMode === 'float') {
      ...
      floatingHeader = <View style={styles.floatingHeader} pointerEvents="box-none">
  ...
  _renderInnerScene(scene) {
    ...
    const headerMode = this._getHeaderMode();
    if (headerMode === 'screen' && !scene.route.routes) {
  ...
  _renderCard = scene => {
    ...
    if (route.routes && route.routes.length) {
      options = this.props.TabOptions[route.routes[route.index].routeName];
    } else {
      options = descriptor.options;
    }
    if (options.cardBackground) {
      style.backgroundColor = options.cardBackground;
    }

    return <Card {...this.props.transitionProps} key={`card_${scene.key}`} transparent={this.props.transparentCard} style={style} scene={scene}>
